...
/// <summary>
/// Summary description for MoneyExpress_corp
/// </summary>
public class MoneyExpress_corp
{
	public MoneyExpress_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<moneyExpress_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into moneyExpress_corp(bcode, month_eli, year_eli, " +
