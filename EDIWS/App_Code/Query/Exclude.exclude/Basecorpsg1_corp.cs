...
/// <summary>
/// Summary description for Basecorpsg1_corp
/// </summary>
public class Basecorpsg1_corp
{
	public Basecorpsg1_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<basecorpsg1_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into basecorpsg1_corp(bcode, paydesc,month_eli, year_eli, " +
