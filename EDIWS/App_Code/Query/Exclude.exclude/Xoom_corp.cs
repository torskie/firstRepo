...
/// <summary>
/// Summary description for Xoom_corp
/// </summary>
public class Xoom_corp
{
	public Xoom_corp()
	{
		//
    ...
    public Response insert(List<xoom_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into xoom_corp(bcode, month_eli, year_eli, " +
