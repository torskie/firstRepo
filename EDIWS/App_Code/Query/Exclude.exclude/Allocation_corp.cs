...
/// <summary>
/// Summary description for Allocation_corp
/// </summary>
public class Allocation_corp
{
	public Allocation_corp()	{	}
    public Response insert(List<allocation_corp> data ,String edi) 
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into allocation_corp(bcode, month_eli, year_eli, " +
