...
/// <summary>
/// Summary description for FixedAssets_corp
/// </summary>
public class FixedAssets_corp
{
	public FixedAssets_corp() {}
    public Response insert(List<fixedassets_corp> data, String edi)
	{
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into FIXEDASSETS_corp(bcode, month_eli, year_eli, " +
