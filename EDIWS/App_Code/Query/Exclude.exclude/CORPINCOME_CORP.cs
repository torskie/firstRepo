...
/// <summary>
/// Summary description for CORPINCOME_CORP
/// </summary>
public class CORPINCOME_CORP
{
	public CORPINCOME_CORP()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<corpincome_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into CORPINCOME_CORP(bcode, month_eli, year_eli, " +
