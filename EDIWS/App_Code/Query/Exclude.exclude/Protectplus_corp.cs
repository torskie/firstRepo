...
/// <summary>
/// Summary description for Protectplus_corp
/// </summary>
public class Protectplus_corp
{
	public Protectplus_corp()
	{
		//
		...
		//
         ...
         public Response insert(List<protectplus_corp> data ,String edi) 
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into protectplus_corp(bcode, month_eli, year_eli, " +
