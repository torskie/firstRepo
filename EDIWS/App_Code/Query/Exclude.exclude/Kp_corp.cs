...
/// <summary>
/// Summary description for Kp_corp
/// </summary>
public class Kp_corp
{
	public Kp_corp() {}
    public Response insert(List<kp_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into kp_corp(bcode, month_eli, year_eli, " +
