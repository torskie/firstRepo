...
/// <summary>
/// Summary description for Midyear_corp
/// </summary>
public class Midyear_corp
{
	public Midyear_corp()
	{
		//
    ...
    public Response insert(List<midyear_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into midyear_corp(bcode, month_eli, year_eli, " +
