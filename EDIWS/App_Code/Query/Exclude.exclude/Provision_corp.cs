...
/// <summary>
/// Summary description for Provision_corp
/// </summary>
public class Provision_corp
{
    public Provision_corp()
    {
        //
    ...
    public Response insert(List<provision_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into provision_corp(bcode, Monthdesc,month_eli, year_eli, " +
