...
/// <summary>
/// Summary description for RRF_corp
/// </summary>
public class RRF_corp
{
	public RRF_corp() {}
    public Response insert(List<rrf_corp> data, String edi)
	{
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into RRF_corp(bcode, descs,month_eli, year_eli, " +
