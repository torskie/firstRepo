...
/// <summary>
/// Summary description for TaxRem_corp
/// </summary>
public class TaxRem_corp
{
	public TaxRem_corp() {}
    public Response insert(List<taxrem_corp> data, String edi)
	{
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into TAXREM_corp(bcode, month_eli, year_eli, " +
