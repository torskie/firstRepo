...
/// <summary>
/// Summary description for Basepayroll_corp
/// </summary>
public class Basepayroll_corp
{
	public Basepayroll_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<basepayroll_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into Basepayroll_corp(bcode, paydesc,month_eli, year_eli, " +
