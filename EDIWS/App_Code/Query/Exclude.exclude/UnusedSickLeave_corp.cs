...
/// <summary>
/// Summary description for UnusedSickLeave_corp
/// </summary>
public class UnusedSickLeave_corp
{
	public UnusedSickLeave_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<unusedSickLeave_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into unusedSickLeave_corp(bcode, month_eli, year_eli, " +
