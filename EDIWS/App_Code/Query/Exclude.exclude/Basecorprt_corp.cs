...
/// <summary>
/// Summary description for Basecorprt_corp
/// </summary>
public class Basecorprt_corp
{
	public Basecorprt_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<basecorprt_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into basecorprt_corp(bcode, month_eli, year_eli, " +
