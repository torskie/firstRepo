...
/// <summary>
/// Summary description for Withholding_corp
/// </summary>
public class Withholding_corp
{
	public Withholding_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<withholding_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into withholding_corp(bcode, month_eli, year_eli, " +
