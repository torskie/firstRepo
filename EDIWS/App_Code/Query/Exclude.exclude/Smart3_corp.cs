...
/// <summary>
/// Summary description for Smart3_corp
/// </summary>
public class Smart3_corp
{
	public Smart3_corp()
	{
		//
    ...
    public Response insert(List<smart3_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into smart3_corp(bcode, companydesc,month_eli, year_eli, " +
