...
/// <summary>
/// Summary description for Baseprovision_corp
/// </summary>
public class Baseprovision_corp
{
	public Baseprovision_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<baseprovision_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into Baseprovision_corp(bcode, month_eli, year_eli, " +
