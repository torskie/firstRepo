...
/// <summary>
/// Summary description for FOREX_corp
/// </summary>
public class FOREX_corp
{
	public FOREX_corp()
	{
		//
    ...
    public Response insert(List<forex_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into FOREX_corp(bcode, monthdesc,month_eli, year_eli, " +
