...
/// <summary>
/// Summary description for ICONNECT_REPLENISH
/// </summary>
public class ICONNECT_REPLENISH
{
	public ICONNECT_REPLENISH()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<iconnect_replenish> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into ICONNECT_REPLENISH(bcode, month_eli, year_eli, " +
