...
/// <summary>
/// Summary description for BaseCorpUnusedSickLeave_corp
/// </summary>
public class BaseCorpUnusedSickLeave_corp
{
	public BaseCorpUnusedSickLeave_corp()
	{
		//
    ...
    public Response insert(List<baseCorpUnusedSickLeave_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into BaseCorpUnusedSickLeave_corp(bcode, paydesc,month_eli, year_eli, " +
