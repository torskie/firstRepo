...
/// <summary>
/// Summary description for SSMI_corp
/// </summary>
public class SSMI_corp
{
	public SSMI_corp()
	{
		//
    ...
    public Response insert(List<ssmi_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into ssmi_corp(bcode, Monthdesc,month_eli, year_eli, " +
