...
/// <summary>
/// Summary description for Sp_corp
/// </summary>
public class Sp_corp
{
	public Sp_corp()
	{
		//
    ...
    public Response insert(List<sp_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into sp_corp(bcode, paydesc,month_eli, year_eli, " +
