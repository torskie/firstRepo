...
/// <summary>
/// Summary description for Sg_corp1
/// </summary>
public class Sg_corp1
{
	public Sg_corp1()
	{
		//
    ...
    public Response insert(List<sg_corp1> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into sg_corp1(bcode, paydesc,month_eli, year_eli, " +
