...
/// <summary>
/// Summary description for Thirmonth_corp
/// </summary>
public class Thirmonth_corp
{
	public Thirmonth_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<thirmonth_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into thirmonth_corp(bcode, month_eli, year_eli, " +
