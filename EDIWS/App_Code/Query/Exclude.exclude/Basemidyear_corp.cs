...
/// <summary>
/// Summary description for Basemidyear_corp
/// </summary>
public class Basemidyear_corp
{
	public Basemidyear_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<basemidyear_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into basemidyear_corp(bcode, paydesc,month_eli, year_eli, " +
