...
/// <summary>
/// Summary description for Insurance_corp
/// </summary>
public class Insurance_corp
{
	public Insurance_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<insurance_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into insurance_corp(bcode, month_eli, year_eli, " +
