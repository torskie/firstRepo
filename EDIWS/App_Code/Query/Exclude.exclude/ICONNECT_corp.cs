...
/// <summary>
/// Summary description for ICONNECT_corp
/// </summary>
public class ICONNECT_corp
{
	public ICONNECT_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<iconnect_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into ICONNECT_corp(bcode, month_eli, year_eli, " +
