...
/// <summary>
/// Summary description for Mmd_corp
/// </summary>
public class Mmd_corp
{
	public Mmd_corp()
	{
		//
    ...
    public Response insert(List<mmd_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into mmd_corp(bcode, month_eli, year_eli, " +
