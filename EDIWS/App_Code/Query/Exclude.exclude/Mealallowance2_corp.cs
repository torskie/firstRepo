...
/// <summary>
/// Summary description for Mealallowance2_corp
/// </summary>
public class Mealallowance2_corp
{
	public Mealallowance2_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<mealallowance2_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into mealallowance2_corp(bcode, monthdesc,month_eli, year_eli, " +
                                "date_time, sys_creator,rowguid) " +
                                "values " +
                                "(@bcode,@monthdesc, @month_eli, @year_eli, " +
        ...
        try
        {
            using (SqlConnection connection = new DBConnection().getEDIConnection(edi))
            {
                using (SqlCommand command = new SqlCommand(sql, connection))
                {
                    ...
                    command.Parameters.Add("@monthdesc", System.Data.SqlDbType.VarChar);
                    ...
                    try
                    {
                        ...
                        for (i = 0; i < data.Count; i++)
                        {
                            ...
                            command.Parameters["@monthdesc"].Value = temp.monthdesc;
