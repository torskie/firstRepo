...
/// <summary>
/// Summary description for Rt_corp
/// </summary>
public class Rt_corp
{
	public Rt_corp()
	{
		//
    ...
    public Response insert(List<rt_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into rt_corp(bcode, month_eli, year_eli, " +
