...
/// <summary>
/// Summary description for NSOConnect_corp
/// </summary>
public class NSOConnect_corp
{
	public NSOConnect_corp() {}
    public Response insert(List<nsoconnect_corp> data, String edi)
	{
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into NSOCONNECT_corp(bcode, month_eli, year_eli, " +
