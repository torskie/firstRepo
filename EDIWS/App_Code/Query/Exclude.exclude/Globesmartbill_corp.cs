...
/// <summary>
/// Summary description for Globesmartbill_corp
/// </summary>
public class Globesmartbill_corp
{
	public Globesmartbill_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<globesmartbill_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into globesmartbill_corp(bcode, companydesc,month_eli, year_eli, " +
                                "date_time, sys_creator,rowguid) " +
                                "values " +
                                "(@bcode,@companydesc, @month_eli, @year_eli, " +
        ...
        try
        {
            using (SqlConnection connection = new DBConnection().getEDIConnection(edi))
            {
                using (SqlCommand command = new SqlCommand(sql, connection))
                {
                    ...
                    command.Parameters.Add("@companydesc", System.Data.SqlDbType.VarChar);
                    ...
                    try
                    {
                        ...
                        for (i = 0; i < data.Count; i++)
                        {
                            ...
                            command.Parameters["@companydesc"].Value = temp.companydesc;
