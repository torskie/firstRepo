...
/// <summary>
/// Summary description for Recurring_corp
/// </summary>
public class Recurring_corp
{
	public Recurring_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<recurring_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into recurring_corp(bcode, month_eli, year_eli, " +
