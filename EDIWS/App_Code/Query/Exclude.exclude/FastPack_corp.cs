...
/// <summary>
/// Summary description for FastPack_corp
/// </summary>
public class FastPack_corp
{
	public FastPack_corp() {}
    public Response insert(List<fastpack_corp> data, String edi)
	{
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into FASTPAK_corp(bcode, month_eli, year_eli, " +
