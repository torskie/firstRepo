...
/// <summary>
/// Summary description for MoneyGram_corp
/// </summary>
public class MoneyGram_corp
{
	public MoneyGram_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<moneyGram_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into moneyGram_corp(bcode, month_eli, year_eli, " +
