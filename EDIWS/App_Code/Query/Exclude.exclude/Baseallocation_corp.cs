...
using log4net;
/// <summary>
/// Summary description for Baseallocation_corp
/// </summary>
public class Baseallocation_corp
{
	public Baseallocation_corp()
	{	}

    public Response insert(List<baseallocation_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into baseallocation_corp(bcode, month_eli, year_eli, " +
