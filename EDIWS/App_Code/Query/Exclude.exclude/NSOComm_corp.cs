...
/// <summary>
/// Summary description for NSOComm_corp
/// </summary>
public class NSOComm_corp
{
	public NSOComm_corp() {}
    public Response insert(List<nsocomm_corp> data, String edi)
	{
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into NSOCOMM_corp(bcode, month_eli, year_eli, " +
