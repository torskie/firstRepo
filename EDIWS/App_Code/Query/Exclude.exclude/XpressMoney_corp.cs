...
/// <summary>
/// Summary description for XpressMoney_corp
/// </summary>
public class XpressMoney_corp
{
    public XpressMoney_corp() { }	
    public Response insert(List<xpressmoney_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into XPRESSMONEY_corp(bcode, month_eli, year_eli, " +
