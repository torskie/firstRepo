...
/// <summary>
/// Summary description for Basethirmonth_corp
/// </summary>
public class Basethirmonth_corp
{
	public Basethirmonth_corp()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public Response insert(List<basethirmonth_corp> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into basethirmonth_corp(bcode, paydesc,month_eli, year_eli, " +
