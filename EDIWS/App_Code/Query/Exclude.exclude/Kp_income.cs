...
/// <summary>
/// Summary description for Kp_income
/// </summary>
public class Kp_income
{
	public Kp_income()
	{
		//
    ...
    public Response insert(List<kp_income> data, String edi)
    {
        Response response = new Response();
        SqlTransaction transaction = null;
        string sql = "Insert into kp_income(bcode, month_eli, year_eli, " +
